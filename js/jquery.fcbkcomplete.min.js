    ...
    $.fn.fcbkcomplete = function(opt) {
        return this.each(function() {
            ...
            function addItem(title, value, preadded, locked, focusme) {
                if (!maxItems() || $.trim(value).length <=0) {
                    return false;
                }
...
//                    if (event.keyCode == 40) {
//                    	var firstArrowDown = feed.data('arrowDown');
//                    	if (firstArrowDown == undefined || firstArrowDown == null) {
//                    		firstArrowDown = 1;
//                    	}
//                    	feed.data('arrowDown', firstArrowDown);
//                    }
