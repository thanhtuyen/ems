...
<p class="help-block">Fields with <span class="required">*</span> are required.</p>
	<div class="space5">
		<?php //echo $form->errorSummary($model); ?>
       	<?php //echo $form->ckEditorRow($model, 'education');?>
		...
		<?php echo $form->textFieldRow($model,'degree',array('class'=>'span3','maxlength'=>255)); ?>
		...
		<?php //echo $form->ckEditorRow($model, 'skill', array('options'=>array('width'=>'640', 'resize_maxWidth'=>'640','resize_minWidth'=>'320')));?>
