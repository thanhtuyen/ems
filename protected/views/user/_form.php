...
<div class="space5">
  ...
  <?php echo $form->dropDownListRow($employeemodel,'department_id', $employeemodel->getDepartmentOption(),array('empty'=>"Please select Department", 'class'=>'span3','maxlength'=>255)); ?>
