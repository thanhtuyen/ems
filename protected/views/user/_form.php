...
<?php //echo $form->errorSummary($model); ?>
    <div class="space5">
      ...
      <?php //echo $form->dropDownListRow($employeemodel,'job_title', Employee::getDepartmentList($employeemodel->department_id),array('empty'=>"Please select Job Title", 'class'=>'span3','maxlength'=>255)); ?>
      <?php endif; ?>
