...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<fieldset style="margin: 0 auto; width: 250px; border-radius: 4px; border: solid thick whiteSmoke; padding: 20px; border-top: 0;">
		...
		<div class="" style="clear:both;float: left;"> 
			<span class="mod_title" style="float: left;"> 
				<?php echo $form->passwordField($model,'old_password',array('style'=>'width:100%','placeholder'=>'Old Password')); ?>
			</span>
		...
		<div class="" style="clear:both;float: left;"> 
			<span class="mod_title" style="float: left;"> 
				<?php echo $form->passwordField($model,'password',array('style'=>'width:100%','placeholder'=>'New Password','value'=>'')); ?>
			</span>
			<span class="help_inline" style="float: left;">
		...
		<div class="" style="clear:both;float: left;"> 
			<span class="mod_title" style="float: left;"> 
				<?php echo $form->passwordField($model,'password_repeat',array('style'=>'width:100%','placeholder'=>'Confirm Password')); ?>
			</span>
			<span class="help_inline" style="float: left;">
